...
function hass() {
    ...
    this.content.style.paddingBottom = '60px';
    this.content.style.fontSize = '30rem';
    this.content.style.fontWeight = '900';
    this.content.style.textAlign = 'center';
    this.content.style.display = 'inline-block';
    this.content.style.border = '3px black solid'
