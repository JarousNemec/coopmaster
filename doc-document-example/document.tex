...
\begin{document}
    ...
    Přestože je v některých oblastech prostor pro další optimalizace a zlepšení (např. lepší noční detekce vetřelců či přesnější rozpoznávání vajec), představuje tento projekt významný krok vpřed ve vývoji moderních řídících a automatizačních systémů pro chov hospodářských zvířat.
