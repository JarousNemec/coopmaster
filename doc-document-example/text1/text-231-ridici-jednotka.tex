...
Zde je vyborným pomocníkem vývojářský nástroj Arduino IDE~\cite{arduino-ide}, který celý složitý proces nahrávání vyřeší.
...
Následně se provede inicializace seriového připojení s rychlostí 9600 baudů.
...
Tato metoda řeší pravidelnou aktualizaci dat ze senzoru dále čtení příkazů ze seriového připojení a posílání odpovědí na ně.
