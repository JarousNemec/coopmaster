...
\input{text-300-camera-driver}

\input{text-301-scale-driver}

\input{text-302-room-driver}

\input{text-303-heatlh-checker}

\input{text-304-room-assistant}

\input{text-305-nest-watcher}

\input{text-306-dog-alarm}

\input{text-307-chicken-watch-guard}

\input{text-308-gui-rozhrani}

\input{text-309-digitalni-vaha}

\input{text-310-ridici-jednotka}

\input{text-311-kamerovy-system}
